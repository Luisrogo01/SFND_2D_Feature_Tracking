                      ...
                      std::vector<cv::DMatch> &matches, std::string descriptorType, std::string matcherType, std::string selectorType)
{
    ...
    else if (matcherType.compare("MAT_FLANN") == 0)
    {
        ...
        {
            int normType = cv::NORM_HAMMING;
            //matcher = cv::makePtr<cv::flann::LshIndexParams>(5, 24, 2);
...
double descKeypoints(vector<cv::KeyPoint> &keypoints, cv::Mat &img, cv::Mat &descriptors, string descriptorType)
{
    ...
    else if(descriptorType.compare("SIFT") == 0)
    {
        ...
        extractor = cv::SiftFeatureDetector::create();
...
double detKeypointsModern(vector<cv::KeyPoint> &keypoints, cv::Mat &img, string detectorType, bool bVis)
{
    ...
    else if (detectorType.compare("BRISK") == 0)
    {
        ...
        cv::Ptr<cv::BRISK> detector = cv::BRISK::create(Threshl,Octaves,PatternScales);
